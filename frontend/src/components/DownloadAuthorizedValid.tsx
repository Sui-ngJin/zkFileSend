...
interface DownloadAuthorizedValidProps {
  onDownload: () => void;
}

const DownloadAuthorizedValid: FunctionComponent<DownloadAuthorizedValidProps> = ({ onDownload }) => {
  return (
...
export default DownloadAuthorizedValid;