...
const schema = z.object({
  ...
  SUI_RPC_URL: z.string().optional().transform((value) => (value && value.length > 0 ? value : undefined)),
...
export const config = {
  ...
  publicBaseUrl: PUBLIC_BASE_URL ?? GOOGLE_REDIRECT_URI.replace(/\/api\/auth\/google\/callback$/, ''),
};
