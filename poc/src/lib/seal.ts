...
import {NETWORK, SUI_RPC, SEAL_SERVER_IDS, SEAL_SERVER_WEIGHTS} from './env.js';
...
const sealCompatibleClient = rawSuiClient as unknown as NonNullable<SealClientOptions['suiClient']>;
